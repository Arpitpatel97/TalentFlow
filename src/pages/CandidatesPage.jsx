        ...
        {viewMode === 'kanban' ? (
          ...
          <>
            ...
            <CandidatesList 
              ...
              isLoading={isLoading} 
            />  {(candidates?.pagination?.total > 0 || (candidates?.candidates && candidates.candidates.length > 0)) && (
              <div className="mt-4 flex justify-center">
                <Pagination
                  currentPage={currentPage}
                  totalPages={Math.ceil((candidates?.pagination?.total || candidates?.candidates?.length || 0) / itemsPerPage)}
                  onPageChange={handlePageChange}
                />
              </div>
            )}
